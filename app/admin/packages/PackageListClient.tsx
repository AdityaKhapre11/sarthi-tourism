    ...
    <div className="grid gap-6">
      ...
      {packages.map((pkg: any) => {
        return (
          <div 
            key={pkg.id} 
            className="group bg-white/[0.02] border border-white/5 hover:border-white/10 hover:bg-white/[0.04] rounded-2xl p-4 transition-all duration-300 relative"
          >
            <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
              ...
              <div className="flex-1 space-y-2 pointer-events-none">
                <div className="flex items-start justify-between gap-4">
                  <h3 className="text-xl font-bold line-clamp-2 leading-tight transition-colors text-white group-hover:text-blue-400">
                    {pkg.name}
                  </h3>
